...
1. Adjust for repeat sampling
  - Multiple observations from the same unit
2. Adjust for imbalanced sampling
  - Observation X sampled 10x more than Y
3. Study variation
  - Useful when question includes variations among a level within the hierarchy
4. Avoid averaging 
  - Features are often pre-averaged for traditional models, destorying the 
    data's variation
